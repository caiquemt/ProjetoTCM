...
namespace WindowsFormsApp1.dominio
{
    class Paciente
    {
        ...
        public string Nasc_pac { get => nasc_pac; set => nasc_pac = value; }
        public string Idade_pac { get => idade_pac; set => idade_pac = value; }
        public string Rg_pac { get => rg_pac; set => rg_pac = value; }
        public string Cpf_pac { get => cpf_pac; set => cpf_pac = value; }
        public string Etnia_pac { get => etnia_pac; set => etnia_pac = value; }
        public string Sexo_pac { get => sexo_pac; set => sexo_pac = value; }
        public string Prontuario_pac { get => prontuario_pac; set => prontuario_pac = value; }
        ...
        public string Numero_rua_pac { get => numero_rua_pac; set => numero_rua_pac = value; }
        public string Complemento_pac { get => complemento_pac; set => complemento_pac = value; }
        public string Cep_pac { get => cep_pac; set => cep_pac = value; }
        ...
        public string Telefone_pac { get => telefone_pac; set => telefone_pac = value; }
        public string Celular_pac { get => celular_pac; set => celular_pac = value; }
